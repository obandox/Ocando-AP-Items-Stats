...
class SyncAPItemCommand extends Command 
{

    protected $signature = 'sync:apitem';
    ...
    public function registerMatch($source, $region,$matchId){
        ...
        foreach ($match['teams'] as $team) {
            $team_model = MatchTeam::firstOrCreate([                
        ...
        foreach ($match['participantIdentities'] as $participantIdentity) {
            MatchParticipantIdentity::firstOrCreate([
                'match_id' => $match_model->id,
        ...
        foreach ($match['participants'] as $participant) {
                ...
                foreach ($participant['masteries'] as $mastery) {
                    MatchParticipantsMastery::firstOrCreate([
                        'match_participant_id' => $participant_model->id,
